...
- [Next] Add packaged-app regressions for switching/importing during pending autosave, composition during navigation, failed persistence retry, and export during dirty state on the supported native hosts. Repeat rename/edit and other applicable scenarios on each additional distributed platform.
