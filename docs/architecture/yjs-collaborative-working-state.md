...
- English: Yjs synchronizes the working draft; validated deterministic checkpoints can be committed as immutable Versions. Archives and Assets stay independent.
